...
constexpr StatusCode StatusCode_MAX = ALREADY_EXISTS;
...
template <> struct is_proto_enum< ::fs::common::StatusCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::fs::common::StatusCode>() {
  return ::fs::common::StatusCode_descriptor();
}
